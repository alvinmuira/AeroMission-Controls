...
def mission():
    ...
    try:
        ...
        click.echo(click.style(f"      =>Current mission details: Name: {mission.name}, Status: {mission.status}, Launch Date: {mission.launch_date}", fg="cyan"))
        id_ = mission.id
        ...
        click.echo(click.style(f"       ✅  Update of {mission.name} to {updated_mission.name} mission was successful!", fg="green"))
        click.echo(click.style(f"            New Status: {updated_mission.status}, New Launch Date: {updated_mission.launch_date}", fg="cyan"))
...
def engineer():
    ...
    try:
        ...
        click.echo(click.style(f"      =>Current engineer details: Name: Eng.{engineer.name}, Specialization: {engineer.specialization}", fg="cyan"))
        id_ = engineer.id
        ...
        click.echo(click.style(f"       ✅  Update of Eng.{engineer.name} to Eng.{updated_engineer.name} was successful!", fg="green"))
        click.echo(click.style(f"            New Specialization: {updated_engineer.specialization}", fg="cyan"))
    except ValueError as ve:
        click.echo(click.style(f"       ❌ Error: {ve}", fg="red"))
...
def equipment():
    ...
    try:
        ...
        click.echo(click.style(f"      =>Current equipment details: Name: {equipment.name}, Type: {equipment.type}, Mission: {equipment.mission.name}", fg="cyan"))
        id_ = equipment.id
        ...
        click.echo(click.style(f"       ✅  Update of {equipment.name} to {updated_equipment.name} was successful!", fg="green"))
        click.echo(click.style(f"            New Type: {updated_equipment.type}, New Mission: {updated_equipment.mission.name}", fg="cyan"))
    except ValueError as ve:
        click.echo(click.style(f"       ❌ Error: {ve}", fg="red"))