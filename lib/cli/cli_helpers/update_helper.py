...
def engineer():
    ...
    value = click.prompt("Enter engineer name or id to update")
    if value.isdigit():
    ...
    try:
        ...
        id_ = engineer.id
        name = click.prompt("Enter new engineer name", type=str)
        specialization = click.prompt("Enter new engineer specialization", type=str)
...
def equipment():
    ...
    value = click.prompt("Enter equipment name or id to update")
    if value.isdigit():
    ...
    try:
        ...
        id_ = equipment.id
        name = click.prompt("Enter new equipment name", type=str)
        type_ = click.prompt("Enter new equipment type", type=str)
        mission_name = click.prompt("Enter new mission name for this equipment", type=str)
        from lib.models.mission import Mission
